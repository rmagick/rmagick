...
class Image_Attributes_UT < Test::Unit::TestCase
  ...
  def test_compose
    ...
    assert_nothing_raised { @img.compose = Magick::UndefinedCompositeOp }
    assert_nothing_raised { @img.compose = Magick::AlphaCompositeOp }
    assert_nothing_raised { @img.compose = Magick::AtopCompositeOp }
    assert_nothing_raised { @img.compose = Magick::BlendCompositeOp }
    assert_nothing_raised { @img.compose = Magick::BlurCompositeOp }
    assert_nothing_raised { @img.compose = Magick::BumpmapCompositeOp }
    assert_nothing_raised { @img.compose = Magick::ChangeMaskCompositeOp }
    ...
    assert_nothing_raised { @img.compose = Magick::CopyAlphaCompositeOp }
    ...
    assert_nothing_raised { @img.compose = Magick::DistortCompositeOp }
    assert_nothing_raised { @img.compose = Magick::DivideDstCompositeOp }
    ...
    assert_nothing_raised { @img.compose = Magick::IntensityCompositeOp }
    ...
    assert_nothing_raised { @img.compose = Magick::LinearBurnCompositeOp }
    assert_nothing_raised { @img.compose = Magick::LinearDodgeCompositeOp }
    assert_nothing_raised { @img.compose = Magick::LinearLightCompositeOp }
    ...
    assert_nothing_raised { @img.compose = Magick::MinusDstCompositeOp }
    ...
    assert_nothing_raised { @img.compose = Magick::PegtopLightCompositeOp }
    assert_nothing_raised { @img.compose = Magick::PinLightCompositeOp }
    ...
    assert_nothing_raised { @img.compose = Magick::VividLightCompositeOp }
    assert_nothing_raised { @img.compose = Magick::XorCompositeOp }
    assert_nothing_raised { @img.compose = Magick::StereoCompositeOp }
    assert_raise(TypeError) { @img.compose = 2 }
  end
