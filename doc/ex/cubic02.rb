...
CONNECT        = { fill: 'none', stroke: '#888888', stroke_width: 2 }.freeze
SAMPLE_PATH    = { fill: 'none', stroke: 'red', stroke_width: 5 }.freeze
END_POINT      = { fill: 'none', stroke: '#888888', stroke_width: 2 }.freeze
CTL_POINT      = { fill: '#888888', stroke: 'none' }.freeze
AUTO_CTL_POINT = { fill: 'none', stroke: 'blue', stroke_width: 4 }.freeze
LABEL          = { text_anchor: 'middle', font_size: 22, font_family: 'Verdana', font_weight: 'normal', font_style: 'normal' }.freeze
