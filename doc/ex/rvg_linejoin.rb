...
MITER = { stroke: 'black', stroke_width: 70, fill: 'none', stroke_linejoin: 'miter' }.freeze
ROUND = { stroke: 'black', stroke_width: 70, fill: 'none', stroke_linejoin: 'round' }.freeze
BEVEL = { stroke: 'black', stroke_width: 70, fill: 'none', stroke_linejoin: 'bevel' }.freeze
THIN  = { stroke: '#ffcccc', stroke_width: 5, fill: 'none' }.freeze
TEXT   = { text_anchor: 'middle', font_size: 50, font_family: 'Verdana' }.freeze
CIRCLE = { fill: '#ffcccc', stroke: 'none' }.freeze
