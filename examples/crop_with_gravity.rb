...
shorts = Magick::Image.read('../doc/ex/images/Shorts.jpg').first

regwidth = shorts.columns / 2
regheight = shorts.rows / 2

mask = Magick::Image.new(regwidth, regheight) { |options| options.background_color = 'white' }
...
black = Magick::Image.new(shorts.columns, shorts.rows) { |options| options.background_color = 'black' }
