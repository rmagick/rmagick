...
Import_ColorInfo(const ColorInfo *ci)
{
    ...
    color      = Pixel_from_PixelInfo(&(ci->color));
 ...
 *
 * Notes:
 *   - The channel values in a PixelInfo are doubles.
 *
 * @param image the Image
 * @param mpp The PixelInfo to modify
...
Color_to_s(VALUE self)
{
    ...
    sprintf(buff, "name=%s, compliance=%s, "
                  ...
                  ci.color.red, ci.color.green, ci.color.blue, ci.color.alpha);
