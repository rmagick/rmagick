...
//  rb_define_method(Class_Image, "plasma", Image_plasma, 6);
    ...
    DEF_ENUM(AlphaChannelOption)
        ...
        ENUMERATOR(DiscreteAlphaChannel)
    ...
    DEF_ENUM(CompositeOperator)
        ...
        ENUMERATOR(IntensityCompositeOp)
