...
Draw_fill_eq(VALUE self, VALUE fill)
{
    ...
    rb_check_frozen(self);
    Data_Get_Struct(self, Draw, draw);
    Color_to_PixelInfo(&draw->info->fill, fill);
    return self;
}
...
Draw_marshal_dump(VALUE self)
{
    ...
    rb_hash_aset(ddraw, CSTR2SYM("fill"), Pixel_from_PixelInfo(&draw->info->fill));
    rb_hash_aset(ddraw, CSTR2SYM("stroke"), Pixel_from_PixelInfo(&draw->info->stroke));
    ...
    rb_hash_aset(ddraw, CSTR2SYM("undercolor"), Pixel_from_PixelInfo(&draw->info->undercolor));
    // rb_hash_aset(ddraw, CSTR2SYM("border_color"), Pixel_from_PixelInfo(&draw->info->border_color)); Montage and Polaroid
    ...
    // rb_hash_aset(ddraw, CSTR2SYM("shadow_color"), Pixel_from_PixelInfo(&draw->shadow_color)); Polaroid-only
...
Draw_stroke_eq(VALUE self, VALUE stroke)
{
    ...
    rb_check_frozen(self);
    Data_Get_Struct(self, Draw, draw);
    Color_to_PixelInfo(&draw->info->stroke, stroke);
    return self;
}
...
Draw_undercolor_eq(VALUE self, VALUE undercolor)
{
    ...
    rb_check_frozen(self);
    Data_Get_Struct(self, Draw, draw);
    Color_to_PixelInfo(&draw->info->undercolor, undercolor);
    return self;
}
...
PolaroidOptions_shadow_color_eq(VALUE self, VALUE shadow)
{
    ...
    rb_check_frozen(self);
    Data_Get_Struct(self, Draw, draw);
    Color_to_PixelInfo(&draw->shadow_color, shadow);
    return self;
}
...
PolaroidOptions_border_color_eq(VALUE self, VALUE border)
{
    ...
    rb_check_frozen(self);
    Data_Get_Struct(self, Draw, draw);
    Color_to_PixelInfo(&draw->info->border_color, border);
    return self;
}
